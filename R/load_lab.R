...
load_pd <- function(lab) {
  ...
  lab_urls_A <- paste0('https://raw.githubusercontent.com/monica23-c/newids_labs/main/',
  ...
  lab_urls_B <- paste0('https://raw.githubusercontent.com/monica23-c/newids_labs/main/',
